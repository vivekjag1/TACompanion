...
const Tracking = ():JSX.Element =>{
  ...
  const fetchData = async () => {
    ...
    const newCourses =  courses.filter((course) => course.role != 'TA');
    setFetched(true);
    return data;
  };
  ...
  return(
    <div className = "ml-[6rem]">
      ...
      <RequirementComponent requirementTitle={"Computer Science - Core Requirement"} requirementDescription={"Computer Science Students must complete 18 CS courses"} requiredNumber={18} coursesCompleted={courses.filter((course) => ((course.requirements as string[]).includes('CS') || (course.requirements as string[]).includes('MQP')))}/>
